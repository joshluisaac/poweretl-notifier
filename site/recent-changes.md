...
* __[2019-01-29]__ Created an API endpoint that allows sending of DC email notification on ad-hoc/urgent basis. This comes handy in non production environments such as SIT and UAT when you need to notify after loading is completed.